        ...
        <p>
            <label for="wp_cat_id">Wordpress Category :
                <?php wp_dropdown_categories(array(
                	...
                	'exclude'            => '',
                	'echo'               => 1,
                	'selected'           => $catmap->wp_category_id,
                	'hierarchical'       => false,
                	'name'               => 'wp_cat_id',
                	'id'                 => '',
                	'class'              => 'postform',
